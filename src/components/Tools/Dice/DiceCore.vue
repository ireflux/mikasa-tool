...
const diceAnimationImages = ref([
  `${base}images/dice/dice_run1.png`,
  `${base}images/dice/dice_run2.png`,
  `${base}images/dice/dice_run3.png`,
  `${base}images/dice/dice_run4.png`
])
//骰子每一个点的对应的图片
const diceImages = ref<Record<number, string>>({
  //1点的图片
  1: `${base}images/dice/dice1.png`,
  //2点的图片
  2: `${base}images/dice/dice2.png`,
  //3点的图片
  3: `${base}images/dice/dice3.png`,
  //4点的图片
  4: `${base}images/dice/dice4.png`,
  //5点的图片
  5: `${base}images/dice/dice5.png`,
  //6点的图片
  6: `${base}images/dice/dice6.png`
})
//当前掷筛子掷到的点数（默认1点）
